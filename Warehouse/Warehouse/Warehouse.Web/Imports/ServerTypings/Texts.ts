    ...
    declare namespace Db {
        ...
        namespace Store {
            ...
            namespace Item {
                ...
                export const ItemCategoryCode: string;
                export const ItemCategoryDescription: string;
                export const ItemCategoryID: string;
                export const ItemCategoryImage: string;
                export const ItemCategoryName: string;
            ...
            namespace ProductDetail {
                ...
                export const InsertUserId: string;
                export const IsActive: string;
                export const ItemAccountID: string;
                export const ItemDiscontinued: string;
                export const ItemID: string;
                export const ItemItemBarcode: string;
                export const ItemItemCategoryID: string;
                export const ItemItemCode: string;
                export const ItemItemImage: string;
                export const ItemItemLabel: string;
                export const ItemItemName: string;
                export const ItemMeasureID: string;
                export const ItemQuantityPerUnit: string;
                export const ItemSupplierID: string;
                export const ItemUnitPrice: string;
