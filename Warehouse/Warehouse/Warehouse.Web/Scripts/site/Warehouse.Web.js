...
(function (Warehouse) {
    ...
    (function (Store) {
        ...
        (function (ItemCategoryRow) {
            ...
            ItemCategoryRow.lookupKey = 'Store.ItemCategories';
            function getLookup() {
                return Q.getLookup('Store.ItemCategories');
            }
    ...
    (function (Store) {
        var ItemGrid = /** @class */ (function (_super) {
            ...
            ItemGrid.prototype.getColumns = function () {
                ...
                category.format = function (ctx) { return _this.selectFormatter(ctx, fld.CategoryID, Store.CategoriesRow.getLookup()); };
        ...
        var ProductDetailDialog = /** @class */ (function (_super) {
            ...
            function ProductDetailDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.PlanPrice.value = Store.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                return _this;
            }
