        ...
        private class MySaveHandler : SaveRequestHandler<MyRow, SaveRequest<MyRow>, SaveResponse>
        {
            protected override void AfterSave()
            {
                ...
                if (Request.Localizations != null)
                    ...
                    {
                        pair.Value.ItemCategoryID = Row.ItemCategoryID.Value;
                        new LocalizationRowHandler<MyRow>().Update<Entities.ItemCategoriesLangRow>(this.UnitOfWork, pair.Value, Convert.ToInt32(pair.Key));
                    }
            }
        }
