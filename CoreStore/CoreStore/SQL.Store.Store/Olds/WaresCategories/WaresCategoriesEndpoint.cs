...
namespace Store.Store.Endpoints
{
    ...
    using MyRepository = Repositories.WaresCategoriesRepository;
    using MyRow = Entities.WaresCategoriesRow;

    [RoutePrefix("Services/Store/WaresCategories"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class WaresCategoriesController : ServiceEndpoint
    {
