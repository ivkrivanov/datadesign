...
/****** Object:  View [dbo].[Expence/Income_Product]    Script Date: 7.2.2019 г. 16:04:27 ******/
SET ANSI_NULLS ON
GO
...
EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=2 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'Expence/Income_Product'
GO
