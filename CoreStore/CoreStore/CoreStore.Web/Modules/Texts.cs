    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your CoreStore Password";
                ...
                {
                    public static LocalText FormTitle = "Welcome to STORE (Serenity Application Template)";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your CoreStore Account";
                    ...
                    public static LocalText FormTitle = "Sign up for CoreStore";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "CoreStore";
        }
        ...
        public static class Site
        {
            ...
            public static class Layout
            {
                ...
                public static LocalText FooterInfo = "DataDesign Platform";
