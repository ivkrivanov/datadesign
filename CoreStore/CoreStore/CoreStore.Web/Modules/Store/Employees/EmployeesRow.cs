...
namespace CoreStore.Store.Entities
{
    ...
    public sealed class EmployeesRow : LoggingRow, IIdRow, INameRow, IIsActiveRow, IMultiTenantRow
    {
        ...
        [DisplayName("Reports To"), ForeignKey(typeof(EmployeesRow)), LeftJoin("jReportsTo"), TextualField("ReportsToLastName")]
