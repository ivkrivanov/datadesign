...
namespace CoreStore.Store {
    ...
    export class ProductsGrid extends Serenity.EntityGrid<ProductsRow, any> {
        ...
        protected getQuickFilters() {
            ...
            flt.push({
                ...
                handler: w => {
                    (this.view.params as ProductsListRequest).WaresId = Q.toId(w.value);
                },
                cssClass: 'hidden-xs'
     ...
     */
        ...
        protected getColumns() {
            ...
            var category = Q.first(columns, x => x.field === fld.CategoryCategoryName);
