...
namespace CoreStore.BasicSamples.Forms
{
    using Store;
    ...
    [BasedOnRow(typeof(Store.Entities.OrderRow), CheckNames = true)]
    public class PopulateLinkedDataForm
    {
        ...
        [OrderDetailsEditor]
        public List<Store.Entities.OrderDetailRow> DetailList { get; set; }
    }
}