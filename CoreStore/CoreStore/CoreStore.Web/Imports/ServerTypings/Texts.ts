    ...
    declare namespace Db {
        ...
        namespace Store {
            ...
            namespace ProductMovement {
                export const CounterpartyAddress: string;
                ...
                export const CounterpartyId: string;
                export const CounterpartyId1: string;
                export const CounterpartyIsActive: string;
                export const CounterpartyPhone: string;
                export const CounterpartyPostalCode: string;
                export const CounterpartyRegion: string;
                export const CounterpartyTenantId: string;
                ...
                export const EmployeeTenantId: string;
                ...
                export const IsActive: string;
                export const OperationTypeId: string;
                export const OperationTypeIsActive: string;
                export const OperationTypeOpCode: string;
                export const OperationTypeOperation: string;
                export const OperationTypeTenantId: string;
                ...
                export const ShipperIsActive: string;
                export const ShipperPhone: string;
                export const ShipperTenantId: string;
                ...
                export const ShopId1: string;
                export const ShopIsActive: string;
                ...
                export const ShopTenantId: string;
                export const TenantId: string;
                export const UpdateDate: string;
                export const UpdateUserId: string;
            }
