...
(function (CoreStore) {
    ...
    })(BasicSamples = CoreStore.BasicSamples || (CoreStore.BasicSamples = {}));
})(CoreStore || (CoreStore = {}));
var CoreStore;
(function (CoreStore) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = CoreStore.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = CoreStore.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = CoreStore.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (CoreStore) {
    ...
    })(Northwind = CoreStore.Northwind || (CoreStore.Northwind = {}));
})(CoreStore || (CoreStore = {}));
var CoreStore;
(function (CoreStore) {
    var Northwind;
...
(function (CoreStore) {
    ...
    (function (Store) {
        ...
        [,
            ['CategoryTypeId', function () { return Serenity.IntegerEditor; }],
            ['CategoryCode', function () { return Serenity.StringEditor; }],
            ['CategoryName', function () { return Serenity.StringEditor; }],
        ...
        ].forEach(function (x) { return Object.defineProperty(CategoriesForm.prototype, x[0], {
            get: function () {
...
(function (CoreStore) {
    ...
    (function (Store) {
        ...
        (function (CategoriesLangRow) {
            ...
            var Fields;
            (function (Fields) {
            })(Fields = CategoriesLangRow.Fields || (CategoriesLangRow.Fields = {}));
            [
                'Id',
                'CategoryId',
                'LanguageId',
...
(function (CoreStore) {
    ...
    (function (Store) {
        ...
        (function (CategoriesLangService) {
            ...
            var Methods;
            (function (Methods) {
            })(Methods = CategoriesLangService.Methods || (CategoriesLangService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                Methods[x] = CategoriesLangService.baseUrl + '/' + x;
            });
...
(function (CoreStore) {
    ...
    (function (Store) {
        ...
        (function (CategoriesRow) {
            ...
            CategoriesRow.nameProperty = 'CategoryCode';
...
(function (CoreStore) {
    ...
    (function (Store) {
        ...
        [,
            ['Type', function () { return Serenity.IntegerEditor; }],
            ['CategoryType', function () { return Serenity.StringEditor; }],
            ['InsertDate', function () { return Serenity.DateEditor; }],
            ['InsertUserId', function () { return Serenity.IntegerEditor; }],
            ['UpdateDate', function () { return Serenity.DateEditor; }],
            ['UpdateUserId', function () { return Serenity.IntegerEditor; }],
            ['IsActive', function () { return Serenity.IntegerEditor; }],
            ['TenantId', function () { return Serenity.IntegerEditor; }]
        ].forEach(function (x) { return Object.defineProperty(CategoriesTypeForm.prototype, x[0], {
            get: function () {
                return this.w(x[0], x[1]());
            },
            enumerable: true,
...
(function (CoreStore) {
    ...
    (function (Store) {
        ...
        (function (CategoriesTypeRow) {
            ...
            CategoriesTypeRow.deletePermission = 'Administration:General';
            CategoriesTypeRow.insertPermission = 'Administration:General';
            CategoriesTypeRow.readPermission = 'Administration:General';
            CategoriesTypeRow.updatePermission = 'Administration:General';
            var Fields;
            (function (Fields) {
            })(Fields = CategoriesTypeRow.Fields || (CategoriesTypeRow.Fields = {}));
            [
                'CategoryTypeId',
                'Type',
                'CategoryType',
...
(function (CoreStore) {
    ...
    (function (Store) {
        ...
        (function (CategoriesTypeService) {
            ...
            var Methods;
            (function (Methods) {
            })(Methods = CategoriesTypeService.Methods || (CategoriesTypeService.Methods = {}));
            [
                'Create',
                'Update',
                'Delete',
                ...
                Methods[x] = CategoriesTypeService.baseUrl + '/' + x;
            });
...
(function (CoreStore) {
    ...
    (function (Store) {
        ...
        (function (CategoryTypeRow) {
            ...
            CategoryTypeRow.deletePermission = 'Store:General';
            CategoryTypeRow.insertPermission = 'Store:General';
            CategoryTypeRow.readPermission = 'Store:General';
            CategoryTypeRow.updatePermission = 'Store:General';
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        ...
        }(CoreStore.Northwind.ProductDialog));
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        ...
        }(CoreStore.Northwind.ProductGrid));
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        CoreStore.Common.ReportHelper.execute({
        ...
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: CoreStore.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: CoreStore.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new CoreStore.Northwind.OrderDialog();
                        ...
                        var chai = CoreStore.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = CoreStore.Northwind.EmployeeRow.getLookup().items
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(CoreStore.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        ...
        }(CoreStore.Northwind.OrderDialog));
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    CoreStore.Northwind.CategoryService.Retrieve({
        ...
        }(CoreStore.Northwind.CategoryDialog));
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        ...
        }(CoreStore.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(CoreStore.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new CoreStore.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                CoreStore.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(CoreStore.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    CoreStore.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(CoreStore.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(CoreStore.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    CoreStore.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return CoreStore.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return CoreStore.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return CoreStore.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return CoreStore.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var SupplierDialog = /** @class */ (function (_super) {
            ...
            SupplierDialog.prototype.getLanguages = function () {
                return CoreStore.LanguageList.getValue();
            };
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        ...
        }(CoreStore.Northwind.SupplierDialog));
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(CoreStore.Northwind.SupplierGrid));
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return CoreStore.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return CoreStore.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return CoreStore.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return CoreStore.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return CoreStore.Northwind.OrderService.baseUrl; };
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                CoreStore.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    CoreStore.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(CoreStore.Northwind.CustomerDialog));
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        ...
        }(CoreStore.Northwind.CustomerGrid));
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.UnitPrice.value = CoreStore.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return CoreStore.Northwind.OrderDetailRow.localTextPrefix; };
        ...
        }(CoreStore.Common.GridEditorDialog));
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return CoreStore.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new CoreStore.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(CoreStore.Northwind.OrderDetailDialog));
...
(function (CoreStore) {
    ...
    (function (Northwind) {
        ...
        }(CoreStore.Common.GridEditorBase));
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        ...
        }(CoreStore.Northwind.OrderDetailsEditor));
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return CoreStore.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return CoreStore.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return CoreStore.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return CoreStore.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return CoreStore.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        ...
        }(CoreStore.Common.BulkServiceAction));
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return CoreStore.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return CoreStore.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return CoreStore.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return CoreStore.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(CoreStore.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new CoreStore.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new CoreStore.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new CoreStore.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (CoreStore) {
    ...
    CoreStore.SelectableEntityGrid = SelectableEntityGrid;
})(CoreStore || (CoreStore = {}));
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return CoreStore.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return CoreStore.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return CoreStore.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return CoreStore.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(CoreStore.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = CoreStore.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            CoreStore.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return CoreStore.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return CoreStore.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return CoreStore.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return CoreStore.Northwind.ProductService.baseUrl; };
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return CoreStore.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return CoreStore.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return CoreStore.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return CoreStore.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return CoreStore.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return CoreStore.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (CoreStore) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return CoreStore.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return CoreStore.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return CoreStore.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
    ...
    (function (Store) {
        var CategoriesExcelImportDialog = /** @class */ (function (_super) {
            ...
            function CategoriesExcelImportDialog() {
                var _this = _super.call(this) || this;
                _this.form = new CategoriesExcelImportForm(_this.idPrefix);
                return _this;
            }
    ...
    (function (Store) {
        var CategoriesGrid = /** @class */ (function (_super) {
            ...
            CategoriesGrid.prototype.getQuickFilters = function () {
                ...
                var q = Q.parseQueryString();
                if (q["cattype"]) {
                    var cattype = Q.tryFirst(flt, function (x) { return x.field == "CategoryTypeId"; });
...
//# sourceMappingURL=CoreStore.Web.js.map