...
public sealed class BusinessEntityAddressRow : LoggingRow<BusinessEntityAddressRow.RowFields>, IIdRow, IIsActiveRow, IMultiTenantRow
{
    ...
    [ServiceLookupEditor(typeof(AddressRow), Service = "Company/Address/List")]
    ...
    [TextualField(nameof(AddressTypeName)), ServiceLookupEditor(typeof(AddressTypeRow), Service = "Company/AddressType/List")]
