...
public sealed class CurrencyRateRow : LoggingRow<CurrencyRateRow.RowFields>, IIdRow, INameRow, IIsActiveRow, IMultiTenantRow
{
    ...
    [DisplayName("From Currency Code"), Size(3), NotNull, ForeignKey(typeof(CurrencyRow)), LeftJoin(jFromCurrencyCode), QuickSearch]
    [NameProperty, TextualField(nameof(FromCurrencyCodeName)), ServiceLookupEditor(typeof(CurrencyRow))]
    public string FromCurrencyCode { get => fields.FromCurrencyCode[this]; set => fields.FromCurrencyCode[this] = value; }

    [DisplayName("To Currency Code"), Size(3), NotNull, ForeignKey(typeof(CurrencyRow)), LeftJoin(jToCurrencyCode)]
    [TextualField(nameof(ToCurrencyCodeName)), ServiceLookupEditor(typeof(CurrencyRow))]
    ...
    public string FromCurrencyCodeName { get => fields.FromCurrencyCodeName[this]; set => fields.FromCurrencyCodeName[this] = value; }

    [DisplayName("To Currency Code Name"), Expression($"{jToCurrencyCode}.[Name]")]
    public string ToCurrencyCodeName { get => fields.ToCurrencyCodeName[this]; set => fields.ToCurrencyCodeName[this] = value; }
