    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your NorthWind Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your NorthWind Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "NorthWind";
        }
