...
namespace Store.Store.Entities
{
    ...
    public sealed class ProductMovementRow : LoggingRow<ProductMovementRow.RowFields>, IIdRow, INameRow, IIsActiveRow, IMultiTenantRow
    {
        ...
        public ProductMovementRow(RowFields Fields)
            : base(Fields)
        {
        }
