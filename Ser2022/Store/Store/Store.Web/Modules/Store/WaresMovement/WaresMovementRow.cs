...
namespace Store.Store.Entities
{
    ...
    [LookupScript(typeof(Scripts.WaresMovementLookup))]
    public sealed class WaresMovementRow : LoggingRow<WaresMovementRow.RowFields>, IIdRow, INameRow, IIsActiveRow, IMultiTenantRow
    {
        [DisplayName("Move Id"), NotNull, Identity, QuickSearch, IdProperty]
        ...
        [DisplayName("Shop"), Size(14), NotNull, ForeignKey(typeof(ShopsRow), "ShopID"), LeftJoin("shop"), NameProperty]
        ...
        public WaresMovementRow(RowFields Fields)
            : base(Fields)
        {
        }
