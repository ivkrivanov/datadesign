...
namespace Store.Store.Entities
{
    ...
    [ConnectionKey("Store"), Module("Store"), TableName("[dbo].[ProductMovementDetails]")]
    ...
    public sealed class ProductMovementDetailsRow : LoggingRow<ProductMovementDetailsRow.RowFields>, IIdRow, IIsActiveRow, IMultiTenantRow
    {
        ...
        public ProductMovementDetailsRow(RowFields Fields)
            : base(Fields)
        {
        }
