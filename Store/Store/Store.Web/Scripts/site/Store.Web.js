...
(function (Store_67) {
    ...
    (function (Store) {
        ...
        (function (StoreMoveService) {
            StoreMoveService.baseUrl = '~/Store/Store/StoreMove';
            [
                'List'
            ].forEach(function (x) {
