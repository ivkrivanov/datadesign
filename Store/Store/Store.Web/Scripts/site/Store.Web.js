...
(function (Store_91) {
    ...
    (function (Store) {
        var CategoryDialog = /** @class */ (function (_super) {
            ...
            CategoryDialog.prototype.getLanguages = function () { return Store_91.LanguageList.getValue(); };
    ...
    (function (Store) {
        var CounterpartyDialog = /** @class */ (function (_super) {
            ...
            function CounterpartyDialog() {
                ...
                Store_96.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Store) {
        var ProductMovementDialog = /** @class */ (function (_super) {
            ...
            ProductMovementDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(Store_99.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
    ...
    (function (Store) {
        var ProductMovementGrid = /** @class */ (function (_super) {
            ...
            ProductMovementGrid.prototype.getButtons = function () {
                ...
                buttons.push(Store_101.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
            ...
            ProductMovementGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        Store_101.Common.ReportHelper.execute({
                            reportKey: 'Store.ProductMovementDetails',
                            params: {
...
(function (Store_118) {
    ...
    (function (Store) {
        var ProductDialog = /** @class */ (function (_super) {
            ...
            ProductDialog.prototype.getLanguages = function () { return Store_118.LanguageList.getValue(); };
    ...
    (function (Store) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getButtons.call(this);
                buttons.push(Store_121.Common.ExcelExportHelper.createToolButton({
                    title: 'Export To Excel',
                    grid: this,
                ...
                buttons.push(Store_121.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (Store_122) {
    ...
    (function (Store) {
        ...
        }(Store_122.Common.GridEditorDialog));
...
(function (Store_125) {
    ...
    (function (Store) {
        ...
        }(Store_125.Common.GridEditorBase));
...
(function (Store_127) {
    ...
    (function (Store) {
        ...
        }(Store_127.Common.GridEditorBase));
    ...
    (function (Store) {
        var WaresGrid = /** @class */ (function (_super) {
            ...
            WaresGrid.prototype.getButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getButtons.call(this);
                buttons.push(Store_143.Common.ExcelExportHelper.createToolButton({
                    title: 'Export To Excel',
                    grid: this,
                ...
                buttons.push(Store_143.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (Store_145) {
    ...
    (function (Store) {
        ...
        }(Store_145.Common.GridEditorDialog));
...
(function (Store_146) {
    ...
    (function (Store) {
        ...
        }(Store_146.Common.GridEditorBase));
