...
(function (Store_95) {
    ...
    (function (Store) {
        var CategoryDialog = /** @class */ (function (_super) {
            ...
            CategoryDialog.prototype.getLanguages = function () { return Store_95.LanguageList.getValue(); };
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Store_120.Authorization.userDefinition.DisplayName,
...
(function (Store_146) {
    ...
    (function (Store) {
        var WaresDialog = /** @class */ (function (_super) {
            ...
            WaresDialog.prototype.getLanguages = function () { return Store_146.LanguageList.getValue(); };
...
(function (Store_151) {
    ...
    (function (Store) {
        ...
        }(Store_151.Common.GridEditorDialog));
...
(function (Store_152) {
    ...
    (function (Store) {
        ...
        }(Store_152.Common.GridEditorBase));
