...
(function (Store_67) {
    ...
    (function (Store) {
        ...
        })(StoreMoveService = Store.StoreMoveService || (Store.StoreMoveService = {}));
...
(function (Store_92) {
    ...
    (function (Store) {
        var CategoryDialog = /** @class */ (function (_super) {
            ...
            CategoryDialog.prototype.getLanguages = function () { return Store_92.LanguageList.getValue(); };
    ...
    (function (Store) {
        var CategoryGrid = /** @class */ (function (_super) {
            ...
            CategoryGrid.prototype.getButtons = function () {
                ...
                buttons.push(Store_94.Common.ExcelExportHelper.createToolButton({
    ...
    (function (Store) {
        var CounterpartyDialog = /** @class */ (function (_super) {
            ...
            function CounterpartyDialog() {
                ...
                Store_97.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Store) {
        var ProductMovementDialog = /** @class */ (function (_super) {
            ...
            ProductMovementDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(Store_100.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            ProductMovementGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        Store_102.Common.ReportHelper.execute({
                            reportKey: 'Store.ProductMovementDetails',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Store_115.Authorization.userDefinition.DisplayName,
...
(function (Store_119) {
    ...
    (function (Store) {
        var ProductDialog = /** @class */ (function (_super) {
            ...
            ProductDialog.prototype.getLanguages = function () { return Store_119.LanguageList.getValue(); };
    ...
    (function (Store) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getButtons.call(this);
                buttons.push(Store_122.Common.ExcelExportHelper.createToolButton({
                    title: 'Export To Excel',
                    grid: this,
                ...
                buttons.push(Store_122.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (Store_123) {
    ...
    (function (Store) {
        ...
        }(Store_123.Common.GridEditorDialog));
...
(function (Store_126) {
    ...
    (function (Store) {
        ...
        }(Store_126.Common.GridEditorBase));
...
(function (Store_127) {
    ...
    (function (Store) {
        ...
        }(Store_127.Common.GridEditorDialog));
...
(function (Store_128) {
    ...
    (function (Store) {
        ...
        }(Store_128.Common.GridEditorBase));
...
(function (Store_141) {
    ...
    (function (Store) {
        var WaresDialog = /** @class */ (function (_super) {
            ...
            WaresDialog.prototype.getLanguages = function () { return Store_141.LanguageList.getValue(); };
...
(function (Store_149) {
    var Store;
    (function (Store) {
        var StoreMove = /** @class */ (function (_super) {
            __extends(StoreMove, _super);
            function StoreMove(container) {
                var _this = _super.call(this, container) || this;
                _this.nextId = 1;
                return _this;
            }
            StoreMove.prototype.getColumnsKey = function () { return "BasicReports.StoreMoves"; };
            StoreMove.prototype.getIdProperty = function () { return "__id"; };
            StoreMove.prototype.getNameProperty = function () { return Store.StoreMoveRow.nameProperty; };
            StoreMove.prototype.getLocalTextPrefix = function () { return Store.StoreMoveRow.localTextPrefix; };
            StoreMove.prototype.getService = function () { return Store.StoreMoveService.baseUrl; };
            StoreMove.prototype.onViewProcessData = function (response) {
            ...
            StoreMove.prototype.getButtons = function () {
                var _this = this;
                var buttons = [];
                buttons.push(Store_149.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Store.StoreMoveService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(Store_149.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
            };
            StoreMove.prototype.createSlickGrid = function () {
                var grid = _super.prototype.createSlickGrid.call(this);
                return grid;
            };
            StoreMove.prototype.getSlickOptions = function () {
                var opt = _super.prototype.getSlickOptions.call(this);
                opt.showFooterRow = true;
                return opt;
            };
            StoreMove.prototype.usePager = function () {
                return false;
            };
            StoreMove.prototype.getQuickFilters = function () {
                var filters = _super.prototype.getQuickFilters.call(this);
