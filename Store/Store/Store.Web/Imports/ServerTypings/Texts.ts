    ...
    declare namespace Db {
        ...
        namespace Store {
            ...
            namespace OrderProduct {
                ...
                export const CounterpartyInsertDate: string;
                export const CounterpartyInsertUserId: string;
                ...
                export const CounterpartyUpdateDate: string;
                export const CounterpartyUpdateUserId: string;
                ...
                export const IsActive: string;
                export const OperationTypeId: string;
                export const OperationTypeInsertDate: string;
                export const OperationTypeInsertUserId: string;
                ...
                export const OperationTypeUpdateDate: string;
                export const OperationTypeUpdateUserId: string;
                export const OrderDate: string;
                export const OrderProductId: string;
                export const RequiredDate: string;
                export const ShipAddress: string;
                export const ShipCity: string;
                export const ShipCountry: string;
                ...
                export const ShipVia: string;
                export const ShipViaCompanyName: string;
                export const ShipViaInsertDate: string;
                export const ShipViaInsertUserId: string;
                export const ShipViaIsActive: string;
                export const ShipViaPhone: string;
                export const ShipViaTenantId: string;
                export const ShipViaUpdateDate: string;
                export const ShipViaUpdateUserId: string;
                export const ShippedDate: string;
                export const TenantId: string;
                export const UpdateDate: string;
                export const UpdateUserId: string;
            ...
            namespace OrderProductDetail {
                export const DetailId: string;
                export const Discount: string;
                export const InsertDate: string;
                export const InsertUserId: string;
                export const IsActive: string;
                export const OrderProductsId: string;
            ...
            namespace WaresMovementDetails {
                ...
                export const WaresName: string;
                export const WaresQuantityPerUnit: string;
                export const WaresSupplierID: string;
                export const WaresUnitPrice: string;
            }
        }
    }
