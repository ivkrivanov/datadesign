...
(function (Store) {
    ...
    (function (BasicReports) {
        var StoreMoveService;
        (function (StoreMoveService) {
            StoreMoveService.baseUrl = 'BasicReports/StoreMove';
            [
                'List'
            ].forEach(function (x) {
                StoreMoveService[x] = function (r, s, o) {
                    return Q.serviceRequest(StoreMoveService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(StoreMoveService = BasicReports.StoreMoveService || (BasicReports.StoreMoveService = {}));
...
(function (Store) {
    var BasicReports;
    (function (BasicReports) {
        var WaresFileService;
        (function (WaresFileService) {
            WaresFileService.baseUrl = 'BasicReports/WaresFile';
            [
                'List'
            ].forEach(function (x) {
                WaresFileService[x] = function (r, s, o) {
                    return Q.serviceRequest(WaresFileService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(WaresFileService = BasicReports.WaresFileService || (BasicReports.WaresFileService = {}));
    })(BasicReports = Store.BasicReports || (Store.BasicReports = {}));
})(Store || (Store = {}));
var Store;
(function (Store) {
...
(function (Store_1) {
    var Store;
    (function (Store) {
        var CategoryExcelImportForm = /** @class */ (function (_super) {
            __extends(CategoryExcelImportForm, _super);
            function CategoryExcelImportForm(prefix) {
                var _this = _super.call(this, prefix) || this;
            ...
            CategoryExcelImportForm.formKey = 'Store.CategoryExcelImport';
            return CategoryExcelImportForm;
        }(Serenity.PrefixedContext));
        Store.CategoryExcelImportForm = CategoryExcelImportForm;
...
(function (Store_44) {
    ...
    (function (Store) {
        var ProductCostsRow;
        (function (ProductCostsRow) {
            ProductCostsRow.idProperty = 'WaresID';
            ProductCostsRow.nameProperty = 'WaresName';
            ProductCostsRow.localTextPrefix = 'Store.ProductCosts';
        })(ProductCostsRow = Store.ProductCostsRow || (Store.ProductCostsRow = {}));
...
(function (Store_45) {
    var Store;
    (function (Store) {
        var ProductCostsService;
        (function (ProductCostsService) {
            ProductCostsService.baseUrl = 'Store/ProductCosts';
            [
                'Retrieve',
                'List'
            ].forEach(function (x) {
                ProductCostsService[x] = function (r, s, o) {
                    return Q.serviceRequest(ProductCostsService.baseUrl + '/' + x, r, s, o);
                };
            });
        })(ProductCostsService = Store.ProductCostsService || (Store.ProductCostsService = {}));
...
(function (Store_49) {
    ...
    (function (Store) {
        var ProductExcelImportForm = /** @class */ (function (_super) {
            ...
            ProductExcelImportForm.formKey = 'Store.ProductExcelImport';
            return ProductExcelImportForm;
        }(Serenity.PrefixedContext));
        Store.ProductExcelImportForm = ProductExcelImportForm;
...
(function (Store_85) {
    ...
    (function (Store) {
        var WaresFileRow;
        (function (WaresFileRow) {
            WaresFileRow.nameProperty = 'WaresCode';
            WaresFileRow.localTextPrefix = 'Store.WaresFile';
            WaresFileRow.lookupKey = 'Store.WaresFile';
            function getLookup() {
                return Q.getLookup('Store.WaresFile');
            }
            WaresFileRow.getLookup = getLookup;
...
(function (Store_101) {
    ...
    (function (Store) {
        var CategoryDialog = /** @class */ (function (_super) {
            ...
            CategoryDialog.prototype.getLanguages = function () { return Store_101.LanguageList.getValue(); };
...
(function (Store_102) {
    ...
    (function (Store) {
        var CategoryExcelImportDialog = /** @class */ (function (_super) {
            __extends(CategoryExcelImportDialog, _super);
            function CategoryExcelImportDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Store.CategoryExcelImportForm(_this.idPrefix);
                return _this;
            }
            CategoryExcelImportDialog.prototype.getDialogTitle = function () {
                return "Excel Import";
            };
            CategoryExcelImportDialog.prototype.getDialogButtons = function () {
                var _this = this;
                return [
                    {
                        text: 'Import',
                        click: function () {
                            ...
                            Store.CategoryService.ExcelImport({
            ...
            CategoryExcelImportDialog = __decorate([
                Serenity.Decorators.registerClass()
            ], CategoryExcelImportDialog);
            ...
            CategoryGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dialog = new Store.CategoryExcelImportDialog();
    ...
    (function (Store) {
        var CounterpartyDialog = /** @class */ (function (_super) {
            ...
            function CounterpartyDialog() {
                ...
                Store_106.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Store) {
        var WaresMovementDialog = /** @class */ (function (_super) {
            ...
            WaresMovementDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(Store_113.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
    ...
    (function (Store) {
        var WaresMovementGrid = /** @class */ (function (_super) {
            ...
            WaresMovementGrid.prototype.getButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getButtons.call(this);
                buttons.push(Store_115.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Store.WaresMovementService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(Store_115.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                buttons.push({
            ...
            WaresMovementGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    e.preventDefault();
                    if (target.hasClass('print-invoice')) {
                        Store_115.Common.ReportHelper.execute({
                            reportKey: 'Store.WaresMovementDetails',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Store_126.Authorization.userDefinition.DisplayName,
...
(function (Store_130) {
    ...
    (function (Store) {
        var ProductDialog = /** @class */ (function (_super) {
            ...
            ProductDialog.prototype.getLanguages = function () { return Store_130.LanguageList.getValue(); };
    ...
    (function (Store) {
        var ProductExcelImportDialog = /** @class */ (function (_super) {
            ...
            function ProductExcelImportDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Store.ProductExcelImportForm(_this.idPrefix);
                return _this;
            }
                ...
                return [
                    {
                        ...
                        click: function () {
                            ...
                            Store.ProductService.ExcelImport({
                                FileName: _this.form.FileName.value.Filename
                            }, function (response) {
                                Q.notifyInfo('Inserted: ' + (response.Inserted || 0) +
                                    ', Updated: ' + (response.Updated || 0));
    ...
    (function (Store) {
        var ProductGrid = /** @class */ (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getButtons.call(this);
                buttons.push(Store_133.Common.ExcelExportHelper.createToolButton({
                    title: 'Export To Excel',
                    grid: this,
                ...
                buttons.push(Store_133.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
            ...
            ProductGrid.prototype.moneyInputFormatter = function (ctx) {
                var klass = 'edit numeric';
                var item = ctx.item;
                var pending = this.pendingChanges[item.ProductID];
                if (pending && pending[ctx.column.field] !== undefined) {
...
(function (Store_136) {
    ...
    (function (Store) {
        var ProductDetailGrid = /** @class */ (function (_super) {
            ...
            ProductDetailGrid.prototype.getSlickOptions = function () {
                var opt = _super.prototype.getSlickOptions.call(this);
                opt.showFooterRow = true;
                return opt;
            };
            ProductDetailGrid.prototype.usePager = function () {
                return false;
            };
...
(function (Store_137) {
    ...
    (function (Store) {
        ...
        }(Store_137.Common.GridEditorBase));
...
(function (Store_138) {
    ...
    (function (Store) {
        var ProductMovementDetailsDialog = /** @class */ (function (_super) {
            ...
            function ProductMovementDetailsDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    ...
                    if (productID != null) {
                        _this.form.SinglePrice.value = Store.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
        ...
        }(Store_138.Common.GridEditorDialog));
    ...
    (function (Store) {
        var StoreDialog = /** @class */ (function (_super) {
            ...
            function StoreDialog() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.form = new Store.StoreForm(_this.idPrefix);
                return _this;
            }
            StoreDialog.prototype.getFormKey = function () { return Store.StoreForm.formKey; };
            StoreDialog.prototype.getIdProperty = function () { return Store.StoreRow.idProperty; };
            StoreDialog.prototype.getLocalTextPrefix = function () { return Store.StoreRow.localTextPrefix; };
            StoreDialog.prototype.getNameProperty = function () { return Store.StoreRow.nameProperty; };
            StoreDialog.prototype.getService = function () { return Store.StoreService.baseUrl; };
...
(function (Store_149) {
    ...
    (function (Store) {
        var StoreGrid = /** @class */ (function (_super) {
            ...
            StoreGrid.prototype.getColumnsKey = function () { return 'Store.Store'; };
            StoreGrid.prototype.getDialogType = function () { return Store.StoreDialog; };
            StoreGrid.prototype.getIdProperty = function () { return Store.StoreRow.idProperty; };
            StoreGrid.prototype.getLocalTextPrefix = function () { return Store.StoreRow.localTextPrefix; };
            StoreGrid.prototype.getService = function () { return Store.StoreService.baseUrl; };
...
(function (Store_152) {
    ...
    (function (Store) {
        var WaresDialog = /** @class */ (function (_super) {
            ...
            WaresDialog.prototype.getLanguages = function () { return Store_152.LanguageList.getValue(); };
...
(function (Store_157) {
    ...
    (function (Store) {
        ...
        }(Store_157.Common.GridEditorDialog));
...
(function (Store_158) {
    ...
    (function (Store) {
        ...
        }(Store_158.Common.GridEditorBase));
...
(function (Store) {
    var BasicReports;
    (function (BasicReports) {
        var WaresFileGrid = /** @class */ (function (_super) {
            __extends(WaresFileGrid, _super);
            function WaresFileGrid(container) {
                var _this = _super.call(this, container) || this;
                _this.nextId = 1;
                return _this;
            }
            WaresFileGrid.prototype.getColumnsKey = function () { return "BasicReports.WaresFile"; };
            WaresFileGrid.prototype.getIdProperty = function () { return "__id"; };
            WaresFileGrid.prototype.getNameProperty = function () { return Store.Store.WaresFileRow.nameProperty; };
            WaresFileGrid.prototype.getLocalTextPrefix = function () { return Store.Store.WaresFileRow.localTextPrefix; };
            WaresFileGrid.prototype.getService = function () { return BasicReports.WaresFileService.baseUrl; };
            WaresFileGrid.prototype.onViewProcessData = function (response) {
                response = _super.prototype.onViewProcessData.call(this, response);
                for (var _i = 0, _a = response.Entities; _i < _a.length; _i++) {
                    var x = _a[_i];
                    x.__id = this.nextId++;
            ...
            WaresFileGrid.prototype.getButtons = function () {
                var _this = this;
                var buttons = [];
                buttons.push(Store.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: BasicReports.WaresFileService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(Store.Common.PdfExportHelper.createToolButton({
            ...
            WaresFileGrid.prototype.createSlickGrid = function () {
                var grid = _super.prototype.createSlickGrid.call(this);
                grid.registerPlugin(new Slick.Data.GroupItemMetadataProvider());
                this.view.setSummaryOptions({
                    aggregators: [
            ...
            WaresFileGrid.prototype.getSlickOptions = function () {
                var opt = _super.prototype.getSlickOptions.call(this);
                opt.showFooterRow = true;
                return opt;
            };
            WaresFileGrid.prototype.usePager = function () {
                return false;
            };
            WaresFileGrid.prototype.getQuickFilters = function () {
                var filters = _super.prototype.getQuickFilters.call(this);
                //var q = Q.parseQueryString();
                //if (q["wares"]) {
            ...
            WaresFileGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], WaresFileGrid);
            return WaresFileGrid;
        }(Serenity.EntityGrid));
        BasicReports.WaresFileGrid = WaresFileGrid;
    })(BasicReports = Store.BasicReports || (Store.BasicReports = {}));
})(Store || (Store = {}));
var Store;
(function (Store) {
