...
namespace Store.Store.Columns
{
    ...
    [ColumnsScript("Store.Counterparty")]
    [BasedOnRow(typeof(Entities.CounterpartyRow), CheckNames = true)]
    public class CounterpartyColumns
    {
        ...
        [Width(130), LookupEditor(typeof(Lookups.CounterpartyCountryLookup)), QuickFilter(CssClass = "hidden-xs")]
        public String Country { get; set; }
        [Width(120), LookupEditor(typeof(Lookups.CounterpartyCityLookup))]
