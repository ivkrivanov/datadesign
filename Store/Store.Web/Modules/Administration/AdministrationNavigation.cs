...
using MyPages = Store.Administration.Pages;
using Administration = Store.Administration.Pages;

[assembly: NavigationMenu(9000, "Administration", icon: "fa-desktop")]
[assembly: NavigationLink(9000, "Administration/Exceptions Log", url: "~/errorlog.axd", permission: Store.Administration.PermissionKeys.Security, icon: "fa-ban", Target = "_blank")]
...
[assembly: NavigationLink(9000, "Administration/Tenant", typeof(MyPages.TenantController), icon: "fa-users")]