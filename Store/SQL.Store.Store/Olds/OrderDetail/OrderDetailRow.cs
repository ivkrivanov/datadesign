...
namespace Store.Store.Entities
{
    ...
    public sealed class OrderDetailRow : LoggingRow, IIdRow, IIsActiveRow, IMultiTenantRow
    {
        ...
        [Origin("o")]
        public String OrderCounterpartyID
        {
            get { return Fields.OrderCounterpartyID[this]; }
            set { Fields.OrderCounterpartyID[this] = value; }
        }
        ...
        public class RowFields : LoggingRowFields
        {
            ...
            public StringField OrderCounterpartyID;
