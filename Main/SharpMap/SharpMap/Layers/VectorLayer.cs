		...
		protected void RenderGeometry(Graphics g, Map map, IGeometry feature, VectorStyle style)
		{
			...
			switch (geometryType)
			{
				...
				case OgcGeometryType.MultiPolygon:
					if (style.EnableOutline)
						VectorRenderer.DrawMultiPolygon(g, (IMultiPolygon) feature, style.Fill, style.Outline,	_clippingEnabled, map);
					else
						VectorRenderer.DrawMultiPolygon(g, (IMultiPolygon) feature, style.Fill, null, _clippingEnabled,	map);
					break;
