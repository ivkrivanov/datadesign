using AdvStore.Administration;
using AdvStore.Administration.Entities;
using AdvStore.Administration.Repositories;
using AdvStore.Common;
...
namespace AdvStore.Membership.Pages
{
