<<<<<<< HEAD
import{a as s}from"../../../../_chunks/chunk-A3BJLZ4J.js";import{a as r}from"../../../../_chunks/chunk-DJXBLXL6.js";import{a as i,b as a,e as u,f as l}from"../../../../_chunks/chunk-RK3EK3FG.js";var n=a(u(),1),e=a(l(),1);$(function(){new t($("#ChangePasswordPanel"))});var t=class extends n.PropertyPanel{constructor(m){super(m);this.form=new s(this.idPrefix),this.form.NewPassword.addValidationRule(this.uniqueName,o=>{if(this.form.ConfirmPassword.value.length<7)return(0,e.format)(r.Validation.MinRequiredPasswordLength,7)}),this.form.ConfirmPassword.addValidationRule(this.uniqueName,o=>{if(this.form.ConfirmPassword.value!==this.form.NewPassword.value)return(0,e.localText)("Validation.PasswordConfirm")}),this.byId("SubmitButton").click(o=>{if(o.preventDefault(),!!this.validateForm()){var d=this.getSaveEntity();(0,e.serviceCall)({url:(0,e.resolveUrl)("~/Account/ChangePassword"),request:d,onSuccess:()=>{(0,e.information)(r.Forms.Membership.ChangePassword.Success,()=>{window.location.href=(0,e.resolveUrl)("~/")})}})}})}getFormKey(){return s.formKey}getTemplate(){return`<div class="s-Panel">
=======
import{a as s}from"../../../../_chunks/chunk-YJ5KSSCH.js";import{a as r}from"../../../../_chunks/chunk-XBHW652S.js";import{a as i,c as a,f as u,g as l}from"../../../../_chunks/chunk-FEDAVPE7.js";var n=a(l(),1),e=a(u(),1);$(function(){new t($("#ChangePasswordPanel"))});var t=class extends n.PropertyPanel{constructor(m){super(m);this.form=new s(this.idPrefix),this.form.NewPassword.addValidationRule(this.uniqueName,o=>{if(this.form.ConfirmPassword.value.length<7)return(0,e.format)(r.Validation.MinRequiredPasswordLength,7)}),this.form.ConfirmPassword.addValidationRule(this.uniqueName,o=>{if(this.form.ConfirmPassword.value!==this.form.NewPassword.value)return(0,e.localText)("Validation.PasswordConfirm")}),this.byId("SubmitButton").click(o=>{if(o.preventDefault(),!!this.validateForm()){var d=this.getSaveEntity();(0,e.serviceCall)({url:(0,e.resolveUrl)("~/Account/ChangePassword"),request:d,onSuccess:()=>{(0,e.information)(r.Forms.Membership.ChangePassword.Success,()=>{window.location.href=(0,e.resolveUrl)("~/")})}})}})}getFormKey(){return s.formKey}getTemplate(){return`<div class="s-Panel">
>>>>>>> revert
