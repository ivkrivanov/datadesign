...
[Route("Services/Company/Currency/[action]")]
[ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
public class CurrencyEndpoint : ServiceEndpoint
{
        ...
        [FromServices] IExcelExporter exporter)
    {
        ...
        var bytes = exporter.Export(data, typeof(Columns.CurrencyColumns), request.ExportColumns);
        return ExcelContentResult.Create(bytes, "CurrencyList_" +
