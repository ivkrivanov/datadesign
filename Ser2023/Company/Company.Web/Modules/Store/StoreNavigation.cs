...
using MyPages = Company.Store.Pages;
...
[assembly: NavigationLink(int.MaxValue, "Store/DocumentType", typeof(MyPages.DocumentTypePage), icon: null)]
...
//[assembly: NavigationLink(int.MaxValue, "Store/Wares Order Details", typeof(MyPages.WaresOrderDetailController), icon: null)]
[assembly: NavigationLink(int.MaxValue, "Store/WaresOrder", typeof(MyPages.WaresOrderController), icon: null)]
...
//[assembly: NavigationLink(int.MaxValue, "Store/Order", typeof(MyPages.ProductMovementController), icon: null)]
...
//[assembly: NavigationLink(int.MaxValue, "Store/Notes", typeof(MyPages.NotesController), icon: null)]
[assembly: NavigationLink(int.MaxValue, "Store/Order", typeof(MyPages.OrderPage), icon: null)]
[assembly: NavigationLink(int.MaxValue, "Store/Order Detail", typeof(MyPages.OrderDetailPage), icon: null)]