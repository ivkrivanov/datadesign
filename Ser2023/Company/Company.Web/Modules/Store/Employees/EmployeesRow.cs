...
public sealed class EmployeesRow : LoggingRow<EmployeesRow.RowFields>, IIdRow, INameRow, IIsActiveRow, IMultiTenantRow
{
    ...
    public string ReportsToLastName { get => fields.ReportsToLastName[this]; set => fields.ReportsToLastName[this] = value; }

    [DisplayName("Reports To First Name"), Expression("jReportsTo.[FirstName]")]
    public string ReportsToFirstName { get => fields.ReportsToFirstName[this];  set => fields.ReportsToFirstName[this] = value; }
    ...
    public string ReportsToTitle { get => fields.ReportsToTitle[this]; set => fields.ReportsToTitle[this] = value; }

    [DisplayName("Reports To Title Of Courtesy"), Expression("jReportsTo.[TitleOfCourtesy]")]
    public string ReportsToTitleOfCourtesy { get => fields.ReportsToTitleOfCourtesy[this]; set => fields.ReportsToTitleOfCourtesy[this] = value; }

    [DisplayName("Reports To Birth Date"), Expression("jReportsTo.[BirthDate]")]
    public DateTime? ReportsToBirthDate { get => fields.ReportsToBirthDate[this]; set => fields.ReportsToBirthDate[this] = value; }

    [DisplayName("Reports To Hire Date"), Expression("jReportsTo.[HireDate]")]
    public DateTime? ReportsToHireDate { get => fields.ReportsToHireDate[this]; set => fields.ReportsToHireDate[this] = value; }

    [DisplayName("Reports To Address"), Expression("jReportsTo.[Address]")]
    public string ReportsToAddress { get => fields.ReportsToAddress[this]; set => fields.ReportsToAddress[this] = value; }

    [DisplayName("Reports To City"), Expression("jReportsTo.[City]")]
    public string ReportsToCity { get => fields.ReportsToCity[this]; set => fields.ReportsToCity[this] = value; }

    [DisplayName("Reports To Region"), Expression("jReportsTo.[Region]")]
    public string ReportsToRegion { get => fields.ReportsToRegion[this]; set => fields.ReportsToRegion[this] = value; }

    [DisplayName("Reports To Postal Code"), Expression("jReportsTo.[PostalCode]")]
    public string ReportsToPostalCode { get => fields.ReportsToPostalCode[this];  set => fields.ReportsToPostalCode[this] = value; }

    [DisplayName("Reports To Country"), Expression("jReportsTo.[Country]")]
    public string ReportsToCountry { get => fields.ReportsToCountry[this]; set => fields.ReportsToCountry[this] = value; }

    [DisplayName("Reports To Home Phone"), Expression("jReportsTo.[HomePhone]")]
    public string ReportsToHomePhone { get => fields.ReportsToHomePhone[this]; set => fields.ReportsToHomePhone[this] = value; }

    [DisplayName("Reports To Extension"), Expression("jReportsTo.[Extension]")]
    public string ReportsToExtension { get => fields.ReportsToExtension[this]; set => fields.ReportsToExtension[this] = value; }

    [DisplayName("Reports To Photo"), Expression("jReportsTo.[Photo]")]
    public Stream ReportsToPhoto { get => fields.ReportsToPhoto[this]; set => fields.ReportsToPhoto[this] = value; }

    [DisplayName("Reports To Notes"), Expression("jReportsTo.[Notes]")]
    public string ReportsToNotes { get => fields.ReportsToNotes[this]; set => fields.ReportsToNotes[this] = value; }

    [DisplayName("Reports To"), Expression("jReportsTo.[ReportsTo]")]
    public int? ReportsToReportsTo { get => fields.ReportsToReportsTo[this]; set => fields.ReportsToReportsTo[this] = value; }

    [DisplayName("Reports To Photo Path"), Expression("jReportsTo.[PhotoPath]")]
    public string ReportsToPhotoPath { get => fields.ReportsToPhotoPath[this];  set => fields.ReportsToPhotoPath[this] = value; }
