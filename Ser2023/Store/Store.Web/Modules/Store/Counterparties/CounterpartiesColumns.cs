...
namespace Store.Store.Columns
{
    ...
    public class CounterpartiesColumns
    {
        ...
        [Width(130), LookupEditor(typeof(Lookups.CounterpartiesCountryLookup)), QuickFilter(CssClass = "hidden-xs")]
        public String Country { get; set; }
        [Width(120), LookupEditor(typeof(Lookups.CounterpartiesCityLookup))]
