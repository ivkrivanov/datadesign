    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your Address Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your Address Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "Address";
        }
