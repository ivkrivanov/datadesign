...
[assembly: NavigationLink(int.MaxValue, "Company/Province", typeof(MyPages.ProvincePage), icon: null)]
[assembly: NavigationLink(int.MaxValue, "Company/Address", typeof(MyPages.AddressPage), icon: null)]


[assembly: NavigationLink(int.MaxValue, "Company/Email Address", typeof(MyPages.EmailAddressPage), icon: null)]
[assembly: NavigationLink(int.MaxValue, "Company/Person Phone", typeof(MyPages.PersonPhonePage), icon: null)]
