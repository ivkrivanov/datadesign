export namespace PermissionKeys {
    ...
    export namespace EmailAddress {
        export const Delete = "Company:EmailAddress:Delete";
        export const Modify = "Company:EmailAddress:Modify";
        export const View = "Company:EmailAddress:View";
    }

    export namespace PersonPhone {
        export const Delete = "Company:PersonPhone:Delete";
        export const Modify = "Company:PersonPhone:Modify";
        export const View = "Company:PersonPhone:View";
    }
