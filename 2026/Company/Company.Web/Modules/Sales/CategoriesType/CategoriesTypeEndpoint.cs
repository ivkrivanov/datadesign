...
[Route("Services/Sales/CategoriesType/[action]")]
[ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
public class CategoriesTypeEndpoint : ServiceEndpoint
{
        ...
        [FromServices] IExcelExporter exporter)
    {
        ...
        var bytes = exporter.Export(data, typeof(Columns.CategoriesTypeColumns), request.ExportColumns);
        return ExcelContentResult.Create(bytes, "CategoriesTypeList_" +
