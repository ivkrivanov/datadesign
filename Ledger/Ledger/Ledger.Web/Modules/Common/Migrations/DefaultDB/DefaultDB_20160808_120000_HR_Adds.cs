    ...
    public class DefaultDB_20160808_120000_HR_Adds : AutoReversingMigration
    {
        public override void Up()
        {
            Create.Table("EmployeesAddresses").InSchema("ldg")
                ...
                .WithColumn("EmployeeId").AsInt32().NotNullable().ForeignKey("FK_EmployeeAddress_Employee", "ldg", "Employees", "EmployeeId")
                .WithColumn("AddressId").AsInt32().NotNullable().ForeignKey("FK_EmployeeAddress_Address", "ldg", "Addresses", "AddressId")
            ...
            Create.Table("EmployeesEmails").InSchema("ldg")
                ...
                .WithColumn("EmployeeId").AsInt32().NotNullable().ForeignKey("FK_EmployeeEmail_Employee", "ldg", "Employees", "EmployeeId")
                .WithColumn("EmailId").AsInt32().NotNullable().ForeignKey("FK_EmployeeEmail_Email", "ldg", "Emails", "EmailId")
            ...
            Create.Table("EmployeesPhones").InSchema("ldg")
                ...
                .WithColumn("EmployeeId").AsInt32().NotNullable().ForeignKey("FK_EmployeePhone_Employee", "ldg", "Employees", "EmployeeId")
                .WithColumn("PhoneId").AsInt32().NotNullable().ForeignKey("FK_EmployeePhone_Phone", "ldg", "Phones", "PhoneId")
