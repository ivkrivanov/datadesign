    ...
    public class DefaultDB_20141123_155100_ProductImage : Migration
    {
        public override void Up()
        {
            IfDatabase("sqlserver")
                .Execute.EmbeddedScript("Ledger.Modules.Common.Migrations.NorthwindDB.NorthwindDBScript_SqlServer.sql");

            IfDatabase("postgres")
                .Execute.EmbeddedScript("Ledger.Modules.Common.Migrations.NorthwindDB.NorthwindDBScript_Postgres.sql");

            IfDatabase("postgres")
                .Execute.EmbeddedScript("Ledger.Modules.Common.Migrations.NorthwindDB.NorthwindDBScript_PostgresData.sql");

            IfDatabase("mysql")
                .Execute.EmbeddedScript("Ledger.Modules.Common.Migrations.NorthwindDB.NorthwindDBScript_MySql.sql");

            IfDatabase("oracle")
                .Execute.EmbeddedScript("Ledger.Modules.Common.Migrations.NorthwindDB.NorthwindDBScript_Oracle.sql");
