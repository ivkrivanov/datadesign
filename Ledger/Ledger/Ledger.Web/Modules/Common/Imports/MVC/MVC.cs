...
namespace MVC
{
    public static class Views
    {
        ...
        public static class HR
        {
            ...
            {
                public const string EmployeeAddressIndex = "~/Modules/HR/EmployeeAddress/EmployeeAddressIndex.cshtml";
            }

            public static class EmployeeEmail
            {
                public const string EmployeeEmailIndex = "~/Modules/HR/EmployeeEmail/EmployeeEmailIndex.cshtml";
            }

            public static class EmployeePhone
            {
                public const string EmployeePhoneIndex = "~/Modules/HR/EmployeePhone/EmployeePhoneIndex.cshtml";
            }
        ...
        public static class Infra
        {
            ...
            {
                public const string AddressesIndex = "~/Modules/Infra/Addresses/AddressesIndex.cshtml";
            }

            public static class Category
            {
                public const string CategoryIndex = "~/Modules/Infra/Category/CategoryIndex.cshtml";
            }

            public static class Currency
            {
                public const string CurrencyIndex = "~/Modules/Infra/Currency/CurrencyIndex.cshtml";
            }

            public static class Email
            {
                public const string EmailIndex = "~/Modules/Infra/Email/EmailIndex.cshtml";
            }
