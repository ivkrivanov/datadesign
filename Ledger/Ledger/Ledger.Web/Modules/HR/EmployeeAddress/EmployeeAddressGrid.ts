namespace Ledger.HR {
    ...
    export class EmployeeAddressGrid extends Serenity.EntityGrid<EmployeeAddressRow, any> {
        ...
        protected getDialogType() { return EmployeeAddressDialog; }
        protected getIdProperty() { return EmployeeAddressRow.idProperty; }
        protected getLocalTextPrefix() { return EmployeeAddressRow.localTextPrefix; }
        protected getService() { return EmployeeAddressService.baseUrl; }
